...
<template>
  <card>
    <edit-carousel v-if="showEditForm" :link="editableLink" @save="saveLink" @cancel="showEditForm = false"></edit-carousel>
    <v-list border rounded class="pa-1">

      <v-list-item v-if="!linkss || linkss.length == 0">
        <v-list-item-title class="text-center">هیچ عکسسی افزوده نشده است.</v-list-item-title>
      </v-list-item>
      ...
      <v-list-item class="text-center">
        <v-btn prepend-icon="mdi-plus" class="my-3" @click="showEditFormDialog">ایجاد عکس جدید</v-btn>
      </v-list-item>
    </v-list>
  </card>
</template>
