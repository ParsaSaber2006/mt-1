...
import PasswordChanged from "@/components/login/PasswordChanged.vue";
import MobileVerification from "@/components/login/MobileVerification.vue";
import UserInfo from "@/components/login/UserInfo.vue";


const props = defineProps(["authMode"]);
...
function sendMobileVerifyToken() {
  if (!data.user.mobile) data.user.mobile = auth.user.mobile;
