...
export const useAuthStore = defineStore('auth', () => {
    ...
    const
        ...
        isAdvisor = computed(() => hasRole("advisor")),
        isMarketer = computed(() => hasRole("marketer")),
    ...
    function requestMobileToken(mobile) {
        return new Promise((resolve, reject) => {
            axios.post("/api/auth/requestMobileToken", { mobile })
                .then(res => {
    ...
    function verifyMobileToken(mobile, token) {
        return new Promise((resolve, reject) => {
            axios.post("/api/auth/verifyMobileToken", { mobile, token })
                .then(res => {
                    resolve(true)
                })
                .catch(err => {
    ...
    function changePasswordByMobileToken(mobile, token, password, password_confirmation) {
        return new Promise((resolve, reject) => {
            axios.post("/api/password/changeByToken", { mobile, token, password, password_confirmation })
                .then(res => {
                    resolve(true)
                })
                .catch(err => {
